...
appcan.define('Slide',function($,exports,module){
    var $support = {
    ...
    var zySlide = function(selector, dir, endFun, lock, transEnd){
        ...
        var first = container.children().first().clone(true);
        var last = container.children().last().clone(true)
        //添加前后节点
